        ...
        <div class="container">
            <div class="box">
                <p class="thanks">
                    ...
                    We are so excited to #FEEDYOURSEOUL with delicious Korean
                    comfort food 💪 🇰🇷
                </p>
                <div class="content">
                    ...
                    <p v-if="curbside">
                        <em
                            >Please call {{ location.phone }} upon arriving at
                            the restaurant and we will bring your order out to
                            you.</em
                        >
                    </p>
                    <h3>Items Ordered</h3>
                    ...
                    <h3>Order Totals</h3>
                    <p>
                        <strong>Subtotal: </strong> {{ itemSubtotal | currency
                        }}<br />
